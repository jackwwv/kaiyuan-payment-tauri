...
<template>
    <div class="input_wrapper">
      ...
      <!-- 输入栏 -->
      <vEditDiv v-show="!recordShow" @onEnter="onEnter" @onFocus="onFocus" @onBlur="onBlur" @click.native="closeDefIconsShow" class="input"  id="edit" placeholder="请输入文字"  v-model="innerText"></vEditDiv>
