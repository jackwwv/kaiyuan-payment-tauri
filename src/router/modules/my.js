 ...
 * @description: 用户路由模块
 * @LastEditors: hua
 * @LastEditTime: 2020-11-22 18:57:55
 */
...
const myRouter = [
    ...
    // 我的/设置//修改用户信息
    {
        path: '/my/set/userInfo', // 路径
        name: 'mySetUserInfo', // 给他个名字，后期路由传参用
        component: _import('my/set/userInfo'), // 载入组件
        meta: { title: '修改用户信息', isShowHead: true, isShowFoot: false, isShowBack: true, backPath:'mySet'} // 定义一些公共状态，你喜欢就好
    },
    // 新的朋友
    {
